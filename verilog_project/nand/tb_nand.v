...
nand_gate dut_nand_gate (.a(A), .b(B), .q(Q_gate));
nand_dataflow dut_nand_dataflow (.a(A), .b(B), .q(Q_data));
nand_behavioral dut_nand_behavioral (.a(A), .b(B), .q(Q_beh));
