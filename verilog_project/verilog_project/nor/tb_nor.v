...
nor_gate dut_nor_gate (.a(A), .b(B), .q(Q_gate));
nor_dataflow dut_nor_dataflow (.a(A), .b(B), .q(Q_data));
nor_behavioral dut_nor_behavioral (.a(A), .b(B), .q(Q_beh));
