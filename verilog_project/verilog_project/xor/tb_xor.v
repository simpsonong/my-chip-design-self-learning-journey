...
xor_gate dut_xor_gate (.a(A), .b(B), .q(Q_gate));
xor_dataflow dut_xor_dataflow (.a(A), .b(B), .q(Q_data));
xor_behavioral dut_xor_behavioral (.a(A), .b(B), .q(Q_beh));
