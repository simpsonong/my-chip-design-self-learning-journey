...
//PARAMETER
parameter TICKPERIOD = 20;                         //TICKPERIOD(controlled by tb)
...
parameter total_group_x_general = 5;               //total number of groups excluding general test groups
...
//INSTANTIATE INPUT
input_register input_register1 #(
