...
G =  ~ (input_out2(A[3],B[3],S) || (input_out1(A[3],B[3],S) && input_out2(A[2],B[2],S)) || 
...
co_bar_general = ~G(A,B,S) || (input_out1(A[3],B[3],S) && input_out1(A[2],B[2],S) && input_out1(A[1],B[1],S) && input_out1(A[0],B[0],S) && CI_BAR);
