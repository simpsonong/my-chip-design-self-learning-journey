...
input [7:0]microadress;
output [23:0]microword
);

reg [3:0]MICROAD_LOW;
reg [7:4]MICROAD_HIGH;
reg COUNT;
reg [12:9]BOP;
reg [21:13]control_bits;
reg A_SOURCE;
reg B_SOURCE;
reg [19:15]ALU_FUNC;
reg CIN;
...
assign control_bits = {ALU_DEST,CIN,ALU_SIGNALS,B_SOURCE,A_SOURCE};
assign microword = {control_bits,BOP,COUNTER,MICROAD_HIGH,MICROAD_LOW};

always@(microadress)begin
    case(microadress)begin
