...
reg eof;
reg flag_one_sided_rst_w;
reg flag_one_sided_rst_r;
reg flag_stop_w;
reg flag_stop_r;
...
if(flag_rst_r[4] && {R_RST,R_EN} == 2'b10 && R_PTR_SYNC2 == 5'b0)begin
{W_RST,W_EN,DATA_IN} = {2'b10, ch};
flag_rst_r[4] = 0;
...
else if(R_PTR > 5'b00010 && flag_stop_w !==1)begin
{W_RST,W_EN,DATA_IN} = {2'b10, ch};
flag_stop_w = 1;
...
if(flag_rst_w[4])begin
if(flag_rst_w[4] && W_RST && R_PTR_SYNC2 == 5'b0)begin
{R_RST,R_EN} = 2'b10;
flag_rst_w[4] = 0;
...
else if(W_PTR > 5'b10000 &&  flag_stop_r!== 1)begin
{R_RST,R_EN} = 2'b10;
flag_stop_r = 1;
end
else begin
